...
class RadarGuidedBEVEncoder(TransformerLayerSequence):
    ...
    def __init__(self, *args, pc_range=None, num_points_in_pillar=4, return_intermediate=False, dataset_type='nuscenes',
        ...
        super(RadarGuidedBEVEncoder, self).__init__(*args, **kwargs)
    ...
    def forward(self,
        ...
        # shift_ref_2d += shift[:, None, None, :] # didn't shift in case of radar fusion
        ...
        for layer in self.operation_order:
            ...
            # spaital cross attention
                ...
                query = self.attentions[attn_index](
                    ...
                    reference_points=ref_3d, # [1, 4, 40000, 3]
                    reference_points_cam=reference_points_cam, # [6, 1, 40000, 4, 2]
                    mask=mask, # None
                    attn_mask=attn_masks[attn_index], # None
                    key_padding_mask=key_padding_mask, # None
                    spatial_shapes=spatial_shapes, # tensor([[116, 200],[ 58, 100],[ 29,  50],[ 15,  25]], device='cuda:0')
                    level_start_index=level_start_index, # level_start_index = [0, 23200, 29000, 30450]
                    **kwargs)
                attn_index += 1
                identity = query
                ...
                radar_bev = self.pts_adaptive_layer(pts_bev[0:bs].permute(0,2,1).contiguous()).permute(0,2,1).contiguous()
