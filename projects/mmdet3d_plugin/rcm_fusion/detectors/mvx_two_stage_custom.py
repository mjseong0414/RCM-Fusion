...
class MVXTwoStageDetectorCustom(Base3DDetector):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(MVXTwoStageDetectorCustom, self).__init__(init_cfg=init_cfg)
        ...
        if pts_fusion_layer:
            ...
            pts_fusion_layer.update(train_cfg=pts_train_cfg)
            pts_test_cfg = test_cfg.pts if test_cfg else None
            pts_fusion_layer.update(test_cfg=pts_test_cfg)
        ...
        if img_rpn_head is not None:
            ...
            img_rpn_head.update(train_cfg=img_train_cfg)
            img_test_cfg = test_cfg.img if test_cfg else None
            img_rpn_head.update(test_cfg=img_test_cfg)
