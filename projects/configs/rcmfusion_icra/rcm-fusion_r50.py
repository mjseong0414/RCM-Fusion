...
train_pipeline = [
    ...
    dict(type='RandomScaleImageMultiViewImageCus', scales=[0.5, 0.5]),
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(type=dataset_type,
                    data_root=data_root,
                    ann_file=data_root + 'nuscenes_infos_train_sweep6_rcm_0911.pkl',
    ...
    val=dict(type=dataset_type,
             data_root=data_root,
             ann_file=data_root + 'nuscenes_infos_val_sweep6_rcm_0911.pkl',
